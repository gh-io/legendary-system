...
4.0 - added Skipjack, CAST-256, Panama, SHA-2 (SHA-256, SHA-384, and SHA-512), and XTR-DH
...
5.5.2 - ported x64 assembly 
language code for AES, Salsa20, Sosemanuk, and Panama
